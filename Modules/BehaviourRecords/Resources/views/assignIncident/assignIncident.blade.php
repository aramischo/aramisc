...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'behaviour_records.assign_incident_search', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'aramisc_form']) }}
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            @else
                                ...
                                <div class="col-lg-2 mt-0">
                                    <div class="primary_input aramisc_mb_20 ">
                                        <label class="primary_input_label" for="">@lang('student.search_by_name')</label>
                                        <input class="primary_input_field" type="text" placeholder="Name" name="name"
        ...
        $(document).ready(function() {
            $('.data-table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'full_name',
                        name: 'aramisc_students.full_name'
                    },
                    {
                        data: 'class_sec',
                        name: 'class_sec'

...
class AramiscModuleStudentParentInfo extends Model
{
    ...
    public function subModule()
    {
        ...
        return $this->hasMany('Modules\RolePermission\Entities\AramiscModuleStudentParentInfo', 'parent_route', 'route')->whereNotNull('route')->where('route', '!=', '')

                    ...
                    @foreach($fees_assigneds as $fees_assigned)
                        @php
                            ...
                            $discount_amount = $fees_assigned->applied_discount;
                              ...
                              $paid = \App\AramiscFeesAssign::feesPayment($fees_assigned->feesGroupMaster->feesTypes->id,$fees_assigned->student_id, $student->id)->sum('amount');
                              $total_grand_paid += $paid;
                              //Sum of total fine for single fees type
                            $fine = \App\AramiscFeesAssign::feesPayment($fees_assigned->feesGroupMaster->feesTypes->id,$fees_assigned->student_id, $student->id)->sum('fine');
                            $total_fine += $fine;

...
Route::group(['middleware' => ['subdomain']], function () {
    Route::prefix('lesson')->group(function () {
        Route::get('/', 'AramiscLessonController@index')->name('lesson')->middleware('userRolePermission:lesson');
        Route::post('/create-store', 'AjaxController@getSubject')->name('lesson.create-store');
        Route::get('lesson', 'AramiscLessonController@addLesson')->name('lesson.addLesson');
        Route::post('lesson', 'AramiscLessonController@storeLesson')->name('lesson.storelesson')->middleware('userRolePermission:lesson.create-store');

        Route::get('get-all-ajax', 'AramiscLessonController@lessonListAjax')->name('ajaxLessonList');

        Route::get('lesson-edit/{class_id}/{section_id}/{subject_id}', 'AramiscLessonController@editLesson')->name('lesson-edit')->middleware('userRolePermission:lesson-edit');

        Route::get('un-lesson-edit/{session_id}/{faculty_id}/{department_id}/{academic_id}/{semester_id}/{semester_label_id}/{subject_id}', 'AramiscLessonController@editLessonForUniVersity')->name('un-lesson-edit')->middleware('userRolePermission:lesson-edit');
        Route::post('lesson-update', 'AramiscLessonController@updateLesson')->name('lesson-update')->middleware('userRolePermission:lesson-edit');
        Route::delete('lesson-delete/{id}', 'AramiscLessonController@deleteLesson')->name('lesson-delete')->middleware('userRolePermission:lesson-delete');
        Route::get('lesson-item-delete/{id}', 'AramiscLessonController@deleteLessonItem')->name('lesson-item-delete')->middleware('userRolePermission:lesson-delete');
        Route::post('lesson-delete', 'AramiscLessonController@destroyLesson')->name('lesson-destroy')->middleware('userRolePermission:lesson-delete');
        Route::get('topic', 'AramiscTopicController@index')->name('lesson.topic')->middleware('userRolePermission:lesson.topic');
        Route::post('topic', 'AramiscTopicController@store')->name('lesson.topic.store')->middleware('userRolePermission:lesson.topic.store');

        Route::get('topic-edit/{id}', 'AramiscTopicController@edit')->name('topic-edit')->middleware('userRolePermission:topic-edit');
        Route::post('topic-update', 'AramiscTopicController@updateTopic')->name('lesson.topic.update')->middleware('userRolePermission:topic-edit');
        Route::post('topic-delete', 'AramiscTopicController@topicdelete')->name('topic-delete')->middleware('userRolePermission:topic-delete');

        Route::get('topicTitle-delete/{id}', 'AramiscTopicController@deleteTopicTitle')->name('topicTitle-delete')->middleware('userRolePermission:topic-delete');

        Route::get('get-all-topics-ajax', 'AramiscTopicController@getAllTopicsAjax')->name('get-all-topics-ajax');

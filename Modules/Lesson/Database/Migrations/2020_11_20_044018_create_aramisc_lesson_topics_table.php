...
class CreateAramiscLessonTopicsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aramisc_lesson_topics', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('aramisc_lesson_topics');
    }
}

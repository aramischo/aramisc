...
class CreateAramiscLessonDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aramisc_lesson_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('aramisc_lesson_details');
    }
}

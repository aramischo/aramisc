                                        ...
                                        <td>
                                            @php
                                                $alllessonPlannerTopic=DB::table('lesson_planners')
                                                                     ->join('aramisc_lessons','aramisc_lessons.id','=','lesson_planners.lesson_detail_id')
                                                                    ->join('aramisc_lesson_topic_details','aramisc_lesson_topic_details.id','=','lesson_planners.topic_detail_id')
                                                                    ->where('lesson_detail_id',$data->lesson_detail_id)
                                                                    ->where('lesson_planners.active_status', 1)
                                                                    ->select('lesson_planners.*','aramisc_lessons.lesson_title','aramisc_lesson_topic_details.topic_title')
                                                                    ->get();
                                            @endphp

                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        @foreach ($aramisc_weekends as $key => $aramisc_weekend)
                                                                            ...
                                                                            if(moduleStatusCheck('University'))
                                                                            {
                                                                                $parentRoutine = App\AramiscWeekend::studentClassRoutineFromRecordUniversity($record->un_academic_id, $record->un_semester_label_id, $aramisc_weekend->id);
                                                                            } else {
    
                                                                                $parentRoutine = App\AramiscWeekend::studentClassRoutineFromRecord($record->class_id, $record->section_id, $aramisc_weekend->id);
                                                                            }
                                                                            @endphp

                ...
                <div class="table-responsive">
                    <table class="table school-table-style" cellspacing="0" width="100%">
                        <thead>
                            ...
                            <tr>
                                ...
                                @foreach($aramisc_weekends as $key=>$aramisc_weekend)
                                    ...
                                    @if( $aramisc_weekend->teacherClassRoutine->count() >$height)
                                        @php
                                            $height =  $aramisc_weekend->teacherClassRoutine->count();
                                        @endphp
                                    @endif
                        ...
                        @php
                            ...
                            $i = 0;
                        @endphp
                            @foreach($aramisc_weekend->teacherClassRoutine as $routine)
                                @php

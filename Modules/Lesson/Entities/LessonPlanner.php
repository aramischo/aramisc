...
class LessonPlanner extends Model
{
    ...
    {
        return $this->belongsTo('Modules\Lesson\Entities\AramiscLesson', 'lesson_detail_id')->withDefault();
    }
    ...
    {
        return $this->belongsTo('Modules\Lesson\Entities\AramiscLessonTopicDetail', 'topic_detail_id')->withDefault();
    }

@php $routine_page_title="All about Aramisc School management system; School management software"; @endphp
                        ...
                        <table class="table table-bordered table-striped" style="width: 100%; table-layout: fixed">
                            <tr>
                                ...
                                @foreach ($aramisc_weekends as $aramisc_weekend)
                                    @if ($aramisc_weekend->classRoutine->count() > $height)
                                        @php
                                            $height = $aramisc_weekend->classRoutine->count();
                                        @endphp
                                    @endif
                                    <th style="margin-top: 0px;padding: 2px; padding-left:8px">{{ @$aramisc_weekend->name }}
                                    </th>
                                @endforeach
                            </tr>
                            @php
                            ...
                            @foreach ($aramisc_weekends as $aramisc_weekend)
                                @php
                                    $i = 0;
                                @endphp
                                @foreach ($aramisc_weekend->classRoutine as $routine)
                                    @php

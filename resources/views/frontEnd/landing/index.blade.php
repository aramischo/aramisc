...
<head>
 ...
 <title> Aramisc school management software & School management system </title>
<meta name="description" content="Aramisc is 100+ unique feature enable school management software system. It can manage all type of school, academy and any educational institution. ">
...
[ {
  ...
  "downloadUrl" : "http://aramiscedu.com",
  "operatingSystem" : "2019",
  "requirements" : "in a complete",
  "screenshot" : "http://aramiscedu.com/public/landing/img/dashboard_preview.png",
  "softwareVersion" : "2.0",
  ...
  "review" : {
    ...
    "reviewBody" : "Query\n                                Account"
        ...
        <meta name="twitter:site" content="@AramiscEdu"/>
        <meta name="twitter:creator" content="@AramiscEdu"/>
        <meta name="twitter:url" content="//aramisc.com/"/>
        <meta name="twitter:title" The Ultimate Education Management System For School,  Institute & Academy"/>
        <meta name="twitter:description" content="Aramisc is a well known School management system and its ERP based Software. So try the free demo today!. Cause Aramisc offers 100+  featured, well-documented and latest academic management software system.. By this multipurpose software system, you can easily manage your school,  university or any kind of organization educational institute. So we can provide you speedy, Secure and clean coded Flexible academy and school management system at affordable prices!"/>
        <meta property="og:image" content="http://aramiscedu.com/public/landing/img/dashboard_preview.png"/>


        <!-- Open Graph data -->
        <meta property="og:type" content="website" />
        <meta property="og:url" content="//aramiscedu.com/"/>
        <meta property="og:image" content="//aramiscedu.com/public/landing/img/dashboard_preview.png"/>
        <meta property="og:title" content="School Management ERP Software & School Management System - Aramisc"/>

        <meta property="og:description" content="Aramisc is a well known School management system and its ERP based Software. So try the free demo today!. Cause Aramisc offers 100+  featured, well-documented and latest academic management software system.. By this multipurpose software system, you can easily manage your school,  university or any kind of organization educational institute. So we can provide you speedy, Secure and clean coded Flexible academy and school management system at affordable prices!"/>
        <meta property="og:site_name" content="Aramisc" />

    <link rel="canonical" href="http://aramiscedu.com" hreflang="en-us" />
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <!-- <a class="btn_1 d-none d-lg-block" target="_blank" href="http://salespanel.aramiscedu.com/">Purchase</a> -->
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-8">
                    <div class="section_tittle text-center">
                        ...
                        <p>it's vast! Aramisc has more additional feature that will expect in a complete solution.</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
    ...
    <section class="contact_us padding_top" id="Support">
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6">
                    <a class="support-link" target="_blank" href="https://ticket.aorasoft.com/aramiscedu">
                        <div class="single_feature">
                            <div class="single_feature_part">
                                <span class="single_feature_icon"><i class="ti-write"></i></span>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="footer_area_text">
                        ...
                        <!-- <a href="http://salespanel.aramiscedu.com/" class="footer_btn"> <i class="ti-shopping-cart-full"></i> -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="copyright_text"> 
                        <p> <img src="{{asset('public/landing/img/copyright.svg')}}" alt="#"> 2019-2020 AramiscEdu - Ultimate Education ERP. All Rights

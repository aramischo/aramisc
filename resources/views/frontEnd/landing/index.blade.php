...
[ {
  ...
  "downloadUrl" : "http://aramisc.com",
  "operatingSystem" : "2019",
  "requirements" : "in a complete",
  "screenshot" : "http://aramisc.com/public/landing/img/dashboard_preview.png",
  "softwareVersion" : "2.0",
  ...
  "review" : {
    ...
    "reviewBody" : "Query\n                                Account"
        ...
        <meta name="twitter:site" content="@aramisc"/>
        <meta name="twitter:creator" content="@aramisc"/>
        ...
        <meta property="og:image" content="http://aramisc.com/public/landing/img/dashboard_preview.png"/>


        <!-- Open Graph data -->
        <meta property="og:type" content="website" />
        <meta property="og:url" content="//aramisc.com/"/>
        <meta property="og:image" content="//aramisc.com/public/landing/img/dashboard_preview.png"/>
    ...
    <link rel="canonical" href="http://aramisc.com" hreflang="en-us" />
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <!-- <a class="btn_1 d-none d-lg-block" target="_blank" href="http://salespanel.aramisc.com/">Purchase</a> -->
    ...
    <section class="contact_us padding_top" id="Support">
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6">
                    <a class="support-link" target="_blank" href="https://ticket.aorasoft.com/aramisc">
                        <div class="single_feature">
                            <div class="single_feature_part">
                                <span class="single_feature_icon"><i class="ti-write"></i></span>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="footer_area_text">
                        ...
                        <!-- <a href="http://salespanel.aramisc.com/" class="footer_btn"> <i class="ti-shopping-cart-full"></i> -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="copyright_text"> 
                        <p> <img src="{{asset('public/landing/img/copyright.svg')}}" alt="#"> 2019-2020 aramisc - Ultimate Education ERP. All Rights

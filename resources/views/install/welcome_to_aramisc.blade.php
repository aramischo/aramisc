...
<head>
    ...
    <link rel="alternate" href="http://aramiscedu.com" hreflang="en-us" />
        ...
        <div class="card">
            ...
            <div class="single-report-admit">
                <div class="card-header">
                    <h2 class="text-center text-uppercase" style="color: whitesmoke">Welcome to Aramiscedu </h2>
                
                </div>
            </div>

            <div class="card-body">
                  <p style="text-align: center">Thank you for choosing Aramiscedu for your school administration. Please follow the steps to complete Aramisc Edu installation!</p>

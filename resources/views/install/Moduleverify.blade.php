...
<head>
    ...
    <title>Aramisc ERP | Verify Your purchase {{@$name}} Module</title>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="justify-content-center">
                    <p class=" text-red purchase-alert">If you are using {{@$name}} Module without purchase, Please contact with us at <a target="_blank" href="mailto:support@aramisc.com">support@aramisc.com</a>.</p>

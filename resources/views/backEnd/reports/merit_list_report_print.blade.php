                            ...
                            <td>
                                <div class="logo_img">
                                    ...
                                    <div class="company_info">
                                        ...
                                        <p>{{isset(generalSetting()->address)?generalSetting()->address:'Aramisc School Address'}}</p>
                                    ...
                                    if (is_array($subject_mark)) {
                                        ...
                                        foreach ($subject_mark as $key => $mark) {
                                            if ($additioncheck[0] != $mark) {                                                                     
                                                $grade_gpa = DB::table('aramisc_marks_grades')->where('percent_from', '<=', $mark)->where('percent_upto', '>=', $mark)->where('academic_id', getAcademicId())->first();
                            ...
                            <td>
                                <?php 
                                    if ($row->result == $failgpaname->grade_name) {
                                        ...
                                        $optional_grade_gpa = DB::table('aramisc_marks_grades')->where('percent_from', '<=', $optional_subject_mark)->where('percent_upto', '>=', $optional_subject_mark)->where('academic_id', getAcademicId())->first();

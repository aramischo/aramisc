                                        ...
                                        <div class="card-body">
                                            <div class="white-box"> 
                                                ...
                                                <div class="row mt-20">
                                                    ...
                                                    <div class="col-lg-6">
                                                        @php
                                                            $mother=App\AramiscStudent::where('aramisc_students.id',$studentDetails->student_id)->join('aramisc_parents','aramisc_parents.id','=','aramisc_students.parent_id')->first();
                                                        @endphp
                                                ...
                                                <div class="row  mt-40 ">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        @php
                                                            ...
                                                            $current_class = App\AramiscStudent::where('aramisc_students.id', $student_id)->join('aramisc_classes', 'aramisc_classes.id', '=', 'aramisc_students.class_id')->first();
                                                            $current_section = App\AramiscStudent::where('aramisc_students.id', $student_id)->join('aramisc_sections', 'aramisc_sections.id', '=', 'aramisc_students.section_id')->first();
                                                            $current_session = App\AramiscStudent::where('aramisc_students.id', $student_id)->join('aramisc_academic_years', 'aramisc_academic_years.id', '=', 'aramisc_students.session_id')->first();

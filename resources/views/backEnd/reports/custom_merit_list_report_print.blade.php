        ...
        <table style="width:100%; border:0;">
                <tr >
                    ...
                    <th colspan="2">
                        ...
                        <p class="text-white mb-0" style="padding-right:10px !important;"> {{isset(generalSetting()->address)?generalSetting()->address:'Aramisc School Address'}} </p>
                    </th>
                ...
                <tr>
                    ...
                    <td  style=" padding:10px; vertical-align:top;">
                         @php $marks_grade=DB::table('aramisc_marks_grades')->where('academic_id', getAcademicId())->orderBy('gpa','desc')->get(); @endphp
                                                    @if(@$marks_grade)

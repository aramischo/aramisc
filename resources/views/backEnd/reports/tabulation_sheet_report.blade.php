                                    ...
                                    <div class="card-header">
                                        <div class="row align-items-center">
                                            ...
                                            <div class=" col-lg-8 text-left text-lg-right mt-30-md">
                                                ...
                                                <p class="text-white mb-0"> {{isset(generalSetting()->address)?generalSetting()->address:'Aramisc School Adress'}} </p>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach($students as $student)
                                                            @php 
                                                                ...
                                                                $opt_sub_gpa=0;
                                                                $optional_subject=App\AramiscOptionalSubjectAssign::where('student_id','=',$student->id)
                                                            ...
                                                            <tr>
                                                                @foreach($subjects as $subject)
                                                                    @php
                                                                        ...
                                                                        $subject_count= 0;
                                                                        $optional_subject_marks=DB::table('aramisc_optional_subject_assigns')
                                                                            ->join('aramisc_mark_stores','aramisc_mark_stores.subject_id','=','aramisc_optional_subject_assigns.subject_id')
                                                                            ->where('aramisc_optional_subject_assigns.student_id','=',$student->id)
                                                                            ->first();
                                                                    @endphp
                                                                @foreach($mark_parts as $sigle_part)

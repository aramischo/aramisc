    ...
    <div class="row">
        <div class="col-lg-4 no-gutters">
            <div class="main-title">
                <h3 class="mb-15">@lang('aramiscTeacherEvaluation.teacher_pending_evaluation_report') </h3>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-lg-3">
            <div class="primary_input " id="subjectSelecttHomeworkDiv">
                ...
                <select
                    ...
                    <option data-display="@lang('aramiscTeacherEvaluation.select_subject')" value="">

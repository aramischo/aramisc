...
@section('mainContent')
            ...
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div>
                            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'parent_aramiscAttendance_search', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student']) }}
                            <div class="row">
    ...
    @isset($records)
        <section class="student-aramiscAttendance white-box mt-40">
            <div class="container-fluid p-0">
                        ...
                        <div class="container-fluid p-0">
                            <div class="row">
                                    ...
                                    <div class="col-lg-12 no-gutters d-flex flex-wrap align-items-center justify-content-between">
                                        ...
                                        <a href="{{route('my_child_aramiscAttendance_print', [$record->student_id,$record->id,$month, $year])}}"

                                                    ...
                                                    <div class="form-section">
                                                        <div class="row">
                                                                                ...
                                                                                <div class="col">
                                                                                    <div class="">
                                                                                        <input
                                                                                            ...
                                                                                            type="text"
                                                                                            name="date_of_birth"
                                                                                            value="{{ dateConvert(date('Y-m-d', strtotime($editData->date_of_birth))) }}"
                                                                                            autocomplete="off">
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="col">
                                                                                    <div class="">
                                                                                        <input
                                                                                            ...
                                                                                            value="{{ dateConvert(date('Y-m-d', strtotime($editData->date_of_joining))) }} "
                                                                                            autocomplete="off">
                                                                                    </div>
                                                                                </div>
                                                                                <button class="btn-date"
                                                            ...
                                                            <div class="col-lg-6 mb-20">
                                                                <div class="col-lg-12">
                                                                    <div class="row">
                                                                        <div class="col-lg-6 primary_input aramisc_mb_20">
                                                                ...
                                                                <div class="col-lg-12 radio-btn-flex">
                                                                    <div class="row">
                                                                        <div class="col-lg-5 primary_input aramisc_mb_20">
                                                                        ...
                                                                        <div class="col-lg-7 primary_input aramisc_mb_20">
                                                                            <input type="radio" name="show_public"

                                                ...
                                                <tbody>
                                                    @foreach($students as $student)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @php
                                                                    $check_discount_apply= DB::table('aramisc_fees_assign_discounts')
                                                                                        ->where('student_id',$student->student_id)
                                                                                        ->where('record_id',$student->id)
                                                                                        ->where('fees_discount_id',$fees_discount_id)
                                                                                        ->leftjoin('aramisc_fees_types','aramisc_fees_types.id','=','aramisc_fees_assign_discounts.fees_type_id')
                                                                                        ->leftjoin('aramisc_fees_groups','aramisc_fees_groups.id','=','aramisc_fees_assign_discounts.fees_group_id')
                                                                                        ->select('aramisc_fees_assign_discounts.*','aramisc_fees_groups.name as fees_group_name','aramisc_fees_types.name as fees_type_name')
                                                                                        ->first();
                                                                    $group_ids= array();
                                                                @endphp

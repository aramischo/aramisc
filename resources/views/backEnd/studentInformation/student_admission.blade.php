                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-section">
                                                        <div class="row">
                                                            ...
                                                            @php
                                                                $classes = DB::table('aramisc_classes')
                                                            ...
                                                            @if (!empty(old('class')))
                                                                @php
                                                                    $old_sections = DB::table('aramisc_class_sections')
                                                                        ->where('class_id', '=', old('class'))
                                                                        ->join('aramisc_sections', 'aramisc_class_sections.section_id', '=', 'aramisc_sections.id')
                                                                        ->get();
                                                                @endphp
                                                                <div class="col-lg-6 mt-4">

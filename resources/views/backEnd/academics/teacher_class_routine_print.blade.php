        ...
        <thead>
            ...
            <tr>
                ...
                if(moduleStatusCheck('University')){
                    $teacherClassRoutineById=App\AramiscWeekend::unTeacherClassRoutineById($aramisc_weekend->id,$teacher_id);
                }else{
                ...
                <th style="padding: 2px; padding-left:8px;">{{@$aramisc_weekend->name}}</th>
                @endforeach
            </tr>
        </thead>

        ...
        <div class="modal-body">
            ...
            <div class='row p-0'>
                ...
                <div class="col-lg-4 pr-0">
                    <input type="checkbox" class="common-checkbox day-checkbox day_{{ $row }}" value="{{ $aramisc_weekend->id }}" data-row_id="{{ $row }}" id="day_{{ $loop->index .'_'. $row }}"
                    name="routine[{{ $row }}][day_ids][]"  >
                        <label for="day_{{ $loop->index .'_'. $row }}">{{ $aramisc_weekend->name }}</label>
                </div>
                @endforeach

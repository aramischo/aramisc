...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $datas = [
            ['Abdur Rahman', 'Doctro', date("Y-m-d", strtotime('1990-12-12')), "abdurrahman@aramiscedu.com", '+881235854', $bloodgroup->id, $religion->id, $gender->id],
            [' Md Rahim ', 'Farmer', date("Y-m-d", strtotime('1993-08-05')), "rahim@aramiscedu.com", '+8855525412', $bloodgroup->id, $religion->id, $gender->id],
            ['Md Malek', 'Engineer', date("Y-m-d", strtotime('1990-12-12')), "malek@aramiscedu.com", '+8852526698', $bloodgroup->id, $religion->id, $gender->id],
        ];

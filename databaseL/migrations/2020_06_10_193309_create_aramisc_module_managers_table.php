...
class CreateAramiscModuleManagersTable extends Migration
{
    ...
    public function up()
    {
        ...
        try {
            ...
            $s->is_default = 0;
            $s->addon_url = "https://codecanyon.net/item/aramiscedu-zoom-live-class/27623128?s_rank=12";
            $s->installed_domain = url('/');
            $s->activated_date = date('Y-m-d');
            $s->save();
            ...
            $s->update_url = "https://spondonit.com/contact";
            $s->is_default = 0;
            $s->addon_url = "https://codecanyon.net/item/razorpay-payment-gateway-for-aramiscedu/27721206?s_rank=11";
            $s->installed_domain = url('/');
            $s->activated_date = date('Y-m-d');
            $s->save();
            ...
            $bulk_print->addon_url = "https://codecanyon.net/item/aramiscedu-zoom-live-class/27623128?s_rank=12";
            ...
            $s->save();
             ...
             $s->update_url = "https://spondonit.com/contact";
             $s->is_default = 0;
             $s->addon_url = "https://codecanyon.net/item/google-meet-module-for-aramiscedu-gmeet-live-class/42463761";
             $s->installed_domain = url('/');
             $s->activated_date = date('Y-m-d');
             $s->save();

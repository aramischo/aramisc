...
class AramiscSchoolSeeder extends Seeder
{
    ...
    public function run()
    {
        AramiscSchool::factory()->times(2)->create()->each(
            function ($school) {
        ...
        //             ],$school_academic));
        //             $smRoute=AramiscRoute::factory()->times(5)->create($school_academic);
        ...
        //                         User::factory()->times(1)->create([
        //                             'role_id' =>2,
        //                             'email'=>'student_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@aramiscedu.com', 
        //                             'username'=>'student_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@aramiscedu.com',
        //                             'school_id' =>$school->id,
        //                         ]);
        //                         User::factory()->times(1)->create([
        //                             'role_id' =>3,
        //                             'email'=>'guardian_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@aramiscedu.com', 
        //                             'username'=>'guardian_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@aramiscedu.com',
        //                             'school_id' =>$school->id,
        //                         ]);
        ...
        //             AramiscChartOfAccount::factory()->times(5)->create($school_academic)->each(function ($smChartOfAccount) use($school_academic){
        ...
        //             $smRoomTypes=AramiscRoomType::where('school_id',$school->id)->where('academic_id',$academic_year->id)->get();
        //             AramiscDormitoryList::factory()->times(5)->create($school_academic)->each(function ($AramiscDormitoryLists) use ($smRoomTypes,$school_academic){
        ...
        //         $s->link_href1  = 'http://aramiscedu.com';
        
        //         $s->link_label2 = 'Aramisc Home';
        //         $s->link_href2  = 'http://aramiscedu.com/home';
        
        //         $s->link_label3 = 'Business';
        //         $s->link_href3  = 'http://aramiscedu.com';
        
        //         $s->link_label4 = 'link_label4';
        //         $s->link_href4  = 'http://aramiscedu.com';
        
        //         $s->link_label5 = 'link_label5';
        //         $s->link_href5  = 'http://aramiscedu.com';
        
        //         $s->link_label6 = 'link_label6';
        //         $s->link_href6  = 'http://aramiscedu.com';
        
        //         $s->link_label7 = 'link_label7';
        //         $s->link_href7  = 'http://aramiscedu.com';
        
        //         $s->link_label8 = 'link_label8';
        //         $s->link_href8  = 'http://aramiscedu.com';
        
        //         $s->link_label9  = 'Home';
        //         $s->link_href9   = 'http://aramiscedu.com/home';
        
        //         $s->link_label10 = 'About';
        //         $s->link_href10  = 'http://aramiscedu.com/about';
        
        
        //         $s->link_label11 = 'Contact';
        //         $s->link_href11  = 'http://aramiscedu.com/contact';
        
        //         $s->link_label12 = 'link_label12';
        //         $s->link_href12  = 'http://aramiscedu.com';
        
        //         $s->link_label13 = 'link_label13';
        //         $s->link_href13  = 'http://aramiscedu.com';
        
        //         $s->link_label14 = 'link_label14';
        //         $s->link_href14  = 'http://aramiscedu.com';
        
        //         $s->link_label15 = 'link_label15';
        //         $s->link_href15  = 'http://aramiscedu.com';
        
        //         $s->link_label16 = 'link_label16';
        //         $s->link_href16  = 'http://aramiscedu.com';
        //         $s->school_id = $school->id; 
        //         $s->save();

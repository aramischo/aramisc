    ...
    public function run()
    {
        ...
        if($allData['Saas'] == TRUE){
            ...
            for($i=2; $i<=5; $i++){
                ...
                $email= $prefix.'_'.$i.'@aramiscedu.com';
                ...
                for ($role_id = 4; $role_id <10; $role_id++) {
                    ...
                    $newUser->email     = $First_Name . $j . '@aramiscedu.com';
                    $newUser->username  = $First_Name . $j . '@aramiscedu.com';
                    ...
                    DB::table('sm_staffs')->insert([
                        ...
                        [
                            ...
                            'gender_id'        => $gender_id,
                            'email'            => $First_Name . $j . '@aramiscedu.com',
                            'mobile'           => '123456789',
                ...
                for ($j = 1; $j <= 20; $j++) {
                                ...
                                $studentEmail = strtolower($student_User_Name) . $j . '@aramiscedu.com';
                                ...
                                $newUser->email     = strtolower($Father_User_Name).'_pa' . $j . '@aramiscedu.com';
                                $newUser->username  = strtolower($Father_User_Name).'_pa' . $j . '@aramiscedu.com';
                                $newUser->password  = Hash::make(123456);
                                ...
                                $parent->guardians_email      = $Guardian_First_Name . $j . '@aramiscedu.com';

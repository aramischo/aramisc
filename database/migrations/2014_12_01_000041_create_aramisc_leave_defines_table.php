...
class CreateAramiscLeaveDefinesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aramisc_leave_defines', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('aramisc_leave_defines');
    }
}

...
class CreateSmCountriesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('aramisc_countries', function (Blueprint $table) {
        ...
        $sql = "INSERT INTO aramisc_countries (code, name, native, phone, continent, capital, currency, languages)  VALUES
    ...
    {
        Schema::dropIfExists('aramisc_countries');
    }
}

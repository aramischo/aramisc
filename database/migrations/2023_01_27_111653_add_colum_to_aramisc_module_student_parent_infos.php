...
class AddColumToAramiscModuleStudentParentInfos extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('aramisc_student_registration_fields', function (Blueprint $table) {
        ...
        if(Schema::hasTable('aramisc_student_fields')) {
            Schema::table('aramisc_student_fields', function (Blueprint $table) {
                if (!Schema::hasColumn($table->getTable(), 'admin_section')) {
                    $table->string('admin_section')->nullable();
                }
            });

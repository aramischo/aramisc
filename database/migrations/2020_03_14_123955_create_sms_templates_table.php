...
class CreateAramiscTemplatesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $allTempletes = [
            ...
            ['sms', 'student_early_checkout', '', 'Dear parent [parent_name], your child [student_name] is checkout  at [attendance_date] to the school on [attendance_date], Thank You [school_name]', 'AramiscBiometrics', '[parent_name], [student_name], [attendance_date], [attendance_date], [school_name]'],

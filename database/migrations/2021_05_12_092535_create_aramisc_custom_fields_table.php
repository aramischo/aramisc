...
class CreateAramiscCustomFieldsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aramisc_custom_fields', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('aramisc_custom_fields');
    }
}

...
class CreateAramiscModulePermissionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('aramisc_module_permissions', function (Blueprint $table) {
       ...
       // $sql = "INSERT INTO `aramisc_module_permissions` (`id`, `dashboard_id`, `name`, `active_status`, `created_by`, `updated_by`, `school_id`, `created_at`, `updated_at`) VALUES
    ...
    {
        Schema::dropIfExists('aramisc_module_permissions');
    }
}

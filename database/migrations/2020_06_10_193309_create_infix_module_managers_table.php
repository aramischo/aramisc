...
class CreateAramiscModuleManagersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aramisc_module_managers', function (Blueprint $table) {
        ...
        try {
            ...
            $s->is_default = 0;
            $s->addon_url = "https://codecanyon.net/item/aramisc-zoom-live-class/27623128?s_rank=12";
            $s->installed_domain = url('/');
            $s->activated_date = date('Y-m-d');
            $s->save();
            ...
            $s->update_url = "https://spondonit.com/contact";
            $s->is_default = 0;
            $s->addon_url = "https://codecanyon.net/item/razorpay-payment-gateway-for-aramisc/27721206?s_rank=11";
            $s->installed_domain = url('/');
            $s->activated_date = date('Y-m-d');
            $s->save();
            ...
            $bulk_print->addon_url = "https://codecanyon.net/item/aramisc-zoom-live-class/27623128?s_rank=12";
            ...
            $s->save();
             ...
             $s->update_url = "https://spondonit.com/contact";
             $s->is_default = 0;
             $s->addon_url = "https://codecanyon.net/item/google-meet-module-for-aramisc-gmeet-live-class/42463761";
             $s->installed_domain = url('/');
             $s->activated_date = date('Y-m-d');
             $s->save();
            ...
            $s->name = "CcAveune";
            $s->email = 'support@spondonit.com';
            $s->notes = "This CcAveune Module For aramisc . Manage online payment for fees & wallet.";
            $s->version = "1.0";
            $s->update_url = "https://spondonit.com/contact";
            $s->is_default = 0;
    ...
    {
        Schema::dropIfExists('aramisc_module_managers');
    }
}
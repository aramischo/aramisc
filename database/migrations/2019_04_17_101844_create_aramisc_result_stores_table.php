...
class CreateAramiscResultStoresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aramisc_result_stores', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->foreign('exam_type_id')->references('id')->on('aramisc_exam_types')->onDelete('cascade');
        ...
        // $sql ="INSERT INTO `aramisc_result_stores` (`id`, `school_id`, `class_id`, `section_id`, `subject_id`, `exam_type_id`, `exam_setup_id`, `student_id`, `student_roll_no`, `student_addmission_no`, `is_absent`, `total_marks`, `total_gpa_point`, `total_gpa_grade`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
    ...
    {
        Schema::dropIfExists('aramisc_result_stores');
    }
}

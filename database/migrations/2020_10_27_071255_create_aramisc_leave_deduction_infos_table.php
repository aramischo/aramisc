...
class CreateAramiscLeaveDeductionInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aramisc_leave_deduction_infos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('aramisc_leave_deduction_infos');
    }
}
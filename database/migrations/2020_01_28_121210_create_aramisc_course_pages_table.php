...
class CreateAramiscCoursePagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aramisc_course_pages', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
        ...
        DB::table('aramisc_course_pages')->insert([
            [
    ...
    {
        Schema::dropIfExists('aramisc_course_pages');
    }
}

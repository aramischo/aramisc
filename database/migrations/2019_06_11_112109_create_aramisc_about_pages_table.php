...
class CreateAramiscAboutPagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aramisc_about_pages', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
        ...
        DB::table('aramisc_about_pages')->insert([
            [
                'title' => 'About Aramisc',
    ...
    {
        Schema::dropIfExists('aramisc_about_pages');
    }
}

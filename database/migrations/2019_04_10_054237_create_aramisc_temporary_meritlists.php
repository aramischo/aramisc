...
class CreateAramiscTemporaryMeritlists extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aramisc_temporary_meritlists', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('aramisc_temporary_meritlists');
    }
}

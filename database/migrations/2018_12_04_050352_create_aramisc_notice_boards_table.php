...
class CreateAramiscNoticeBoardsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aramisc_notice_boards', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('aramisc_notice_boards');
    }
}

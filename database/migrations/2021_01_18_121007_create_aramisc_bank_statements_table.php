...
class CreateAramiscBankStatementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aramisc_bank_statements', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('aramisc_bank_statements');
    }
}

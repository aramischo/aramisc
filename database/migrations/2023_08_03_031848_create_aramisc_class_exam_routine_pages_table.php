...
return new class extends Migration
{
    ...
    {
        Schema::create('aramisc_class_exam_routine_pages', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
        ...
        DB::table('aramisc_class_exam_routine_pages')->insert([
            [
                'title' => 'Routine',
    ...
    {
        Schema::dropIfExists('aramisc_class_exam_routine_pages');
    }
};

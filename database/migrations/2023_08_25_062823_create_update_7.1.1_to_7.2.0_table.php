...
return new class extends Migration
{
    public function up()
    {
        ...
        Schema::table('aramisc_fees_carry_forwards', function (Blueprint $table) {
            if(!Schema::hasColumn('aramisc_fees_carry_forwards', 'balance_type')){
                $table->string('balance_type')->nullable();
            }
            if(!Schema::hasColumn('aramisc_fees_carry_forwards', 'due_date')){
        ...
        Schema::table('aramisc_exam_types', function (Blueprint $table) {
            ...
            if(!Schema::hasColumn('aramisc_exam_types', 'percantage')){
                $table->float('percantage')->default(100)->nullable();
            }
        });

        Schema::table('aramisc_general_settings', function (Blueprint $table) {
            if(!Schema::hasColumn('aramisc_general_settings', 'InAppLiveClass')){
                $table->tinyInteger('InAppLiveClass')->default(0);
            }

            if(!Schema::hasColumn('aramisc_general_settings', 'BehaviourRecords')){
                $table->tinyInteger('BehaviourRecords')->default(1);
            }

        });

        Schema::table('aramisc_events', function (Blueprint $table) {
            if(!Schema::hasColumn('aramisc_events', 'role_ids')){
                $table->text('role_ids')->nullable();
            }
            if (!Schema::hasColumn('aramisc_events', 'url')) {

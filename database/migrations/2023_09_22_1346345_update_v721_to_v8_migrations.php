...
return new class extends Migration
{
    public function up()
    {
        ...
        Schema::table('aramisc_testimonials', function (Blueprint $table) {
            if (!Schema::hasColumn('aramisc_testimonials', 'star_rating')) {
        ...
        Schema::table('aramisc_students', function (Blueprint $table) {
            if (!Schema::hasColumn('aramisc_students', 'aditional_notes')) {
                $table->text('aditional_notes')->nullable()->change();
                //column type varchar change to text
            }
        });

        Schema::table('aramisc_news', function (Blueprint $table) {
            if (!Schema::hasColumn('aramisc_news', 'status')) {
                $table->tinyInteger('status')->default(1)->nullable();
            }
            if (!Schema::hasColumn('aramisc_news', 'is_global')) {
                $table->tinyInteger('is_global')->default(1)->nullable();
            }
            if (!Schema::hasColumn('aramisc_news', 'auto_approve')) {
                $table->tinyInteger('auto_approve')->default(0)->nullable();
            }
            if (!Schema::hasColumn('aramisc_news', 'is_comment')) {
                $table->tinyInteger('is_comment')->default(0)->nullable();
            }
        });

        Schema::table('aramisc_general_settings', function (Blueprint $table) {
            if (!Schema::hasColumn('aramisc_general_settings', 'auto_approve')) {
                $table->tinyInteger('auto_approve')->default(1)->nullable();
            }
            if (!Schema::hasColumn('aramisc_general_settings', 'is_comment')) {
                $table->tinyInteger('is_comment')->default(1)->nullable();
            }
            if (!Schema::hasColumn('aramisc_general_settings', 'AiContent')) {
                $table->integer('AiContent')->default(0)->nullable();
            }
            if (!Schema::hasColumn('aramisc_general_settings', 'WhatsappSupport')) {
                $table->integer('WhatsappSupport')->default(0)->nullable();
            }
            if (!Schema::hasColumn('aramisc_general_settings', 'DownloadCenter')) {
                $table->integer('DownloadCenter')->default(0)->nullable();
            }
            if (!Schema::hasColumn('aramisc_general_settings', 'active_theme')) {
        ...
        // Header Menu Manage Start
            Schema::table('aramisc_header_menu_managers', function (Blueprint $table) {
                if (!Schema::hasColumn('aramisc_header_menu_managers', 'theme')) {
        ...
        Schema::table('aramisc_general_settings', function (Blueprint $table) {
            if (!Schema::hasColumn('aramisc_general_settings', 'blog_search')) {
                $table->tinyInteger('blog_search')->default(1)->nullable();
            }
            if (!Schema::hasColumn('aramisc_general_settings', 'recent_blog')) {

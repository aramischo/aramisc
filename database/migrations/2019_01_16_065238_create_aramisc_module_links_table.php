...
class CreateAramiscModuleLinksTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('aramisc_module_links', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('module_id')->nullable()->unsigned();
            $table->foreign('module_id')->references('id')->on('aramisc_modules')->onDelete('cascade');
    ...
    // DB::table('aramisc_module_links')->truncate();
    // DB::statement('SET foreign_key_checks=1');
     ...
     //   $sql = "INSERT INTO `aramisc_module_links` (`id`, `module_id`, `name`, `route`, `active_status`, `created_by`, `updated_by`, `school_id`, `created_at`, `updated_at`) VALUES
    ...
    {
        Schema::dropIfExists('aramisc_module_links');
    }
}
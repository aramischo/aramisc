...
class CreateAramiscModulePermissionAssignsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('aramisc_module_permission_assigns', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->foreign('module_id')->references('id')->on('aramisc_module_permissions')->onDelete('cascade');
       ...
       // $sql = "INSERT INTO `aramisc_module_permission_assigns` (`id`, `active_status`, `created_at`, `updated_at`, `module_id`, `role_id`, `created_by`, `updated_by`, `school_id`) VALUES
    ...
    {
        Schema::dropIfExists('aramisc_module_permission_assigns');
    }
}

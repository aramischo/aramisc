...
class CreateAramiscStudentIdCardsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aramisc_student_id_cards', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('aramisc_student_id_cards');
    }
}

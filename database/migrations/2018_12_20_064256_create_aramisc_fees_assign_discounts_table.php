...
class CreateAramiscFeesAssignDiscountsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aramisc_fees_assign_discounts', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('aramisc_fees_assign_discounts');
    }
}
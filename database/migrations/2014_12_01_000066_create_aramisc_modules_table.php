...
class CreateAramiscModulesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aramisc_modules', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
        ...
        foreach ($modules as $module) {
            DB::table('aramisc_modules')->insert([
                [
                    'name' => $module,
                    'order' => $count++,
    ...
    {
        Schema::dropIfExists('aramisc_modules');
    }
}

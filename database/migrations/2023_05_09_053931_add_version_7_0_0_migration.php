...
class AddVersion700Migration extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('aramisc_item_receives', function (Blueprint $table) {
            if(Schema::hasColumn('aramisc_item_receives', 'grand_total')){
                $table->float('grand_total')->nullable()->change();
            }           
        });
        Schema::table('aramisc_item_receives', function (Blueprint $table) {
            if(Schema::hasColumn('aramisc_item_receives', 'total_quantity')){
                $table->float('total_quantity')->nullable()->change();
            }           
        });
        Schema::table('aramisc_item_receives', function (Blueprint $table) {
            if(Schema::hasColumn('aramisc_item_receives', 'total_paid')){
                $table->float('total_paid')->nullable()->change();
            }           
        });
        Schema::table('aramisc_item_receives', function (Blueprint $table) {
            if(Schema::hasColumn('aramisc_item_receives', 'total_due')){
                $table->float('total_due')->nullable()->change();
            }           
        });
        Schema::table('aramisc_item_receive_children', function (Blueprint $table) {
            if(Schema::hasColumn('aramisc_item_receive_children', 'unit_price')){
                $table->float('unit_price')->nullable()->change();
            }           
        });
        Schema::table('aramisc_item_receive_children', function (Blueprint $table) {
            if(Schema::hasColumn('aramisc_item_receive_children', 'quantity')){
                $table->float('quantity')->nullable()->change();
            }           
        });
        Schema::table('aramisc_item_receive_children', function (Blueprint $table) {
            if(Schema::hasColumn('aramisc_item_receive_children', 'sub_total')){
        ...
        Schema::table('aramisc_item_sells', function (Blueprint $table) {
            if(Schema::hasColumn('aramisc_item_sells', 'grand_total')){
                $table->float('grand_total')->nullable()->change();
            }           
        });
        Schema::table('aramisc_item_sells', function (Blueprint $table) {
            if(Schema::hasColumn('aramisc_item_sells', 'total_quantity')){
                $table->float('total_quantity')->nullable()->change();
            }           
        });
        Schema::table('aramisc_item_sells', function (Blueprint $table) {
            if(Schema::hasColumn('aramisc_item_sells', 'total_paid')){
                $table->float('total_paid')->nullable()->change();
            }           
        });
        Schema::table('aramisc_item_sells', function (Blueprint $table) {
            if(Schema::hasColumn('aramisc_item_sells', 'total_due')){
                $table->float('total_due')->nullable()->change();
            }           
        });
        ...
        Schema::table('aramisc_exams', function (Blueprint $table) {
            if(!Schema::hasColumn('aramisc_exams', 'parent_id')){
        ...
        Schema::table('aramisc_class_sections', function (Blueprint $table) {
            if (!Schema::hasColumn('aramisc_class_sections', 'class_id')) {
                if (!Schema::hasColumn('aramisc_class_sections', 'section_id')) {
        ...
        Schema::table('aramisc_exam_types', function (Blueprint $table) {
            if (!Schema::hasColumn('aramisc_exam_types', 'parent_id')) {
                $table->integer('parent_id')->nullable()->default(0)->unsigned();
            }
        });

        Schema::table('aramisc_student_certificates', function (Blueprint $table) {
            if (!Schema::hasColumn('aramisc_student_certificates', 'body_two')) {
                $table->text('body_two')->nullable();
            }
        });

        Schema::table('aramisc_student_certificates', function (Blueprint $table) {
            if (!Schema::hasColumn('aramisc_student_certificates', 'certificate_no')) {
                $table->text('certificate_no')->nullable();
            }
        });

        Schema::table('aramisc_student_certificates', function (Blueprint $table) {
            if (!Schema::hasColumn('aramisc_student_certificates', 'type')) {

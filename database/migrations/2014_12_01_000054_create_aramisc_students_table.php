...
class CreateAramiscStudentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aramisc_students', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->foreign('bloodgroup_id')->references('id')->on('aramisc_base_setups')->onDelete('set null');

            $table->integer('religion_id')->nullable()->unsigned();
            $table->foreign('religion_id')->references('id')->on('aramisc_base_setups')->onDelete('set null');

            $table->integer('route_list_id')->nullable()->unsigned();
            $table->foreign('route_list_id')->references('id')->on('aramisc_routes')->onDelete('set null');

            $table->integer('dormitory_id')->nullable()->unsigned();
            $table->foreign('dormitory_id')->references('id')->on('aramisc_dormitory_lists')->onDelete('set null');

            $table->integer('vechile_id')->nullable()->unsigned();
            $table->foreign('vechile_id')->references('id')->on('aramisc_vehicles')->onDelete('set null');

            $table->integer('room_id')->nullable()->unsigned();
            $table->foreign('room_id')->references('id')->on('aramisc_room_lists')->onDelete('set null');

            $table->integer('student_category_id')->nullable()->unsigned();
            $table->foreign('student_category_id')->references('id')->on('aramisc_student_categories')->onDelete('set null');

            $table->integer('student_group_id')->nullable()->unsigned();
            $table->foreign('student_group_id')->references('id')->on('aramisc_student_groups')->onDelete('set null');

            $table->integer('class_id')->nullable()->unsigned();
            $table->foreign('class_id')->references('id')->on('aramisc_classes')->onDelete('set null');

            $table->integer('section_id')->nullable()->unsigned();
            $table->foreign('section_id')->references('id')->on('aramisc_sections')->onDelete('set null');

            $table->integer('session_id')->nullable()->unsigned();
            $table->foreign('session_id')->references('id')->on('aramisc_academic_years')->onDelete('set null');

            $table->integer('parent_id')->nullable()->nullable()->unsigned();
            $table->foreign('parent_id')->references('id')->on('aramisc_parents')->onDelete('set null');
            ...
            $table->foreign('gender_id')->references('id')->on('aramisc_base_setups')->onDelete('set null');
    ...
    {
        Schema::table('aramisc_students', function (Blueprint $table) {
        ...
        Schema::dropIfExists('aramisc_students');
    }
}
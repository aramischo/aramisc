...
class CreateAramiscClassRoutineUpdatesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('aramisc_class_routine_updates', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->foreign('class_period_id')->references('id')->on('aramisc_class_times')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('aramisc_class_routine_updates');
    }
}

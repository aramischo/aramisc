...
class CreateAramiscBooksTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('aramisc_books', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->foreign('book_category_id')->references('id')->on('aramisc_book_categories')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('aramisc_books');
    }
}

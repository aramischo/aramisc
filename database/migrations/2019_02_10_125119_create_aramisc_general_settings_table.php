...
class CreateAramiscGeneralSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aramisc_general_settings', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->foreign('language_id')->references('id')->on('aramisc_languages')->onDelete('set null');

            $table->integer('date_format_id')->nullable()->default(1)->unsigned();
            $table->foreign('date_format_id')->references('id')->on('aramisc_date_formats')->onDelete('set null');
            ...
            $table->foreign('academic_id')->references('id')->on('aramisc_academic_years')->onDelete('set null');
        ...
        DB::table('aramisc_general_settings')->insert([
            [

...
use Database\Factories\AramiscNoticeBoardFactory;

class AramiscNoticeBoardTableSeeder extends Seeder
{
    /**
    ...
    {
        // AramiscNoticeBoard::factory()->times($count)->create([
        //     'school_id'=>$school_id,
        ...
        DB::table('aramisc_notice_boards')->insert([
            ...
            [
                ...
                'notice_message' => "Stay tuned for exciting upcoming events at AramiscEdu School, including Book Fair, Sports, and Debate competition. We encourage all students and parents to actively participate and make these events memorable experiences for the entire school community.",
            ...
            [
                ...
                'notice_message' => "AramiscEdu School will be closed for the winter break from 15/12/2024 to 31/12/2024. We wish all our students and their families a joyful and restful holiday season.",

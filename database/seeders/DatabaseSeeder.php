...
use Database\Seeders\Lesson\AramiscLessonsTableSeeder;
...
use Database\Seeders\Lesson\AramiscLessonPlansTableSeeder;
...
use Database\Seeders\UploadContent\AramiscUploadContentTableSeeder;
...
//        $this->call(AramiscSchoolSeeder::class);
        ...
        foreach ($schools as $school) {
            ...
            foreach ($academicYears as $academicYear) {
                ...
                $this->callWith(AramiscLessonsTableSeeder::class, array_merge($params, ['count' => 5]));
                $this->callWith(SmTopicsTableSeeder::class, array_merge($params, ['count' => 5]));
                $this->callWith(AramiscLessonPlansTableSeeder::class, array_merge($params, ['count' => 5]));
                ...
                $this->callWith(AramiscUploadContentTableSeeder::class, array_merge($params, ['count' => 5]));

...
class AramiscEventTableSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        DB::table('aramisc_events')->insert([
            [
                ...
                Prepare for an electrifying event as AramiscEdu proudly announces its upcoming Robotics Competition set to ignite the campus with technological brilliance and inventive spirit.
                Event Overview:

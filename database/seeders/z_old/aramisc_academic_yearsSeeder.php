...
class aramisc_academic_yearsSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        // $aramisc_general_setting = AramiscGeneralSettings::first();
        // $aramisc_general_setting->session_id = $academic_year->id;
        // $aramisc_general_setting->save();
        ...
        //     $aramisc_general_setting = AramiscGeneralSettings::where('school_id', $i)->first();
        //     $aramisc_general_setting->session_id = $academic_year->id;
        //     $aramisc_general_setting->save();
        // }
    }

...
class aramisc_schoolsSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        if($allData['Saas'] == TRUE){
            ...
            for($i=2; $i<=5; $i++){
                ...
                $email= $prefix.'_'.$i.'@aramiscdu.com';
                ...
                $staff->school_id       = $i;
                $staff->email           = $email;
                $staff->staff_photo     = 'public/uploads/staff/1_aramisc_edu.jpg';
                $staff->casual_leave    = '12';
                $staff->medical_leave   = '15';
                $staff->metarnity_leave = '15';
                $staff->save();

                DB::table('aramisc_testimonials')->insert([
                    [
                        ...
                        'description' => 'its vast! Aramisc has more additional feature that will expect in a complete solution.',
                ...
                DB::table('aramisc_events')->insert([
                    [
                ...
                DB::table('aramisc_notice_boards')->insert([
                    [
                ...
                DB::table('aramisc_subjects')->insert([
                ...
                for ($role_id = 4; $role_id <10; $role_id++) {
                    ...
                    $newUser->email     = $First_Name . $j . '@aramiscdu.com';
                    $newUser->username  = $First_Name . $j . '@aramiscdu.com';
                    ...
                    DB::table('aramisc_staffs')->insert([
                        ...
                        [
                            ...
                            'gender_id'        => $gender_id,
                            'email'            => $First_Name . $j . '@aramiscdu.com',
                            'mobile'           => '123456789',
                ...
                for ($j = 1; $j <= 20; $j++) {
                                ...
                                $studentEmail = strtolower($student_User_Name) . $j . '@aramiscdu.com';
                                ...
                                $newUser->email     = strtolower($Father_User_Name).'_pa' . $j . '@aramiscdu.com';
                                $newUser->username  = strtolower($Father_User_Name).'_pa' . $j . '@aramiscdu.com';
                                $newUser->password  = Hash::make(123456);
                                ...
                                $parent->guardians_email      = $Guardian_First_Name . $j . '@aramiscdu.com';
                                ...
                                DB::table('aramisc_students')->insert([
                                    [
                                        'user_id'                 => $student_id,
                ...
                $examType= AramiscExamType::where('school_id',$i)->where('academic_id',$i)->first('id')->id;
                ...
                $students = AramiscStudent::where('school_id',$i)->where('academic_id',$i)->get();
                $infos = AramiscExamAttendance::where('school_id',$i)->where('academic_id',$i)->get();
                ...
                DB::statement('SET FOREIGN_KEY_CHECKS=0');
                $feeesGroups = AramiscFeesGroup::where('school_id',$i)->where('academic_id',$i)->get();

                $array = ['Library','Sports','Environment','E-learning'];
                foreach($feeesGroups as $key =>$feeesGroup){
                        $store                  = new AramiscFeesType();
                ...
                $feesTypeData = AramiscFeesType::where('school_id',$i)->where('academic_id',$i)->get();
                ...
                $feesMaterDatas = AramiscFeesMaster::where('school_id',$i)->where('academic_id',$i)->get();
                foreach($students as $student){
            ...
            $findSaas= AramiscModuleManager::where('name','Saas')->first();
            $saasPurchase= AramiscModuleManager::find($findSaas->id);

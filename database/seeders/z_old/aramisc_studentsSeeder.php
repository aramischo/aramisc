...
class aramisc_studentsSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        for ($i = 1; $i <= 200; $i++) {
            ...
            for ($class_id = 1; $class_id <= 1; $class_id++) {
                for ($section_id = 1; $section_id <= 1; $section_id++) {
                    ...
                    $studentEmail = strtolower($student_User_Name) . $i . '@aramiscdu.com';
                    ...
                    $newUser->email     = $Guardian_First_Name . $i . '@aramiscdu.com';
                    $newUser->username  = $Guardian_First_Name . $i . '@aramiscdu.com';
                    $newUser->password  = Hash::make(123456);
                    ...
                    $parent->guardians_email      = $Guardian_First_Name . $i . '@aramiscdu.com';
        ...
        $aramisc_students = DB::table('aramisc_students')->get();
        foreach ($aramisc_students as $row) {
            $data = array(
                'userid' => $row->user_id,

...
class aramisc_schoolsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for($i=2; $i<=5; $i++){
            ...
            DB::table('aramisc_email_settings')->insert([
                [
            ...
            $aramisc_langs = AramiscLanguage::where('school_id',$i)->get();
                        foreach($aramisc_langs as $lang){
            ...
            DB::table('aramisc_weekends')->insert([
                [
                    'name' => 'Saturday',
                    'order' => 1,
                    'is_weekend' => 0,

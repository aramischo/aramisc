...
class AramiscExamSchedulesTableSeeder extends Seeder
{
    /**
    ...
    {
        $assign_subjects = AramiscAssignSubject::where(['school_id' => $school_id, 'academic_id' => $academic_id])->distinct(['class_id','section_id','subject_id'])->get();
        $aramisc_exams = AramiscExamType::where(['school_id' => $school_id, 'academic_id' => $academic_id])->get();
        $start_time =['09:00:00', '10:30:00', '12:00:00', '14:00:00', '15:39:00'];
        $end_time = ['09:45:00', '11:15:00', '12:45:00', '14:45:00', '16:39:00'];
        foreach ($aramisc_exams as $exam) {        

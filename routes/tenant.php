...
Route::group(['middleware' => []], function () {
    ...
    //for localization
    Route::get('locale/{locale}', 'Admin\SystemSettings\AramiscSystemSettingController@changeLocale');
    Route::get('change-language/{id}', 'Admin\SystemSettings\AramiscSystemSettingController@changeLanguage')->name('change-language');
    ...
    Route::get('custom-links', 'Admin\SystemSettings\AramiscSystemSettingController@customLinks')->name('custom-links')->middleware('userRolePermission:custom-links');
    Route::post('custom-links-update', 'Admin\SystemSettings\AramiscSystemSettingController@customLinksUpdate')->name('custom-links-update')->middleware('userRolePermission:custom-links-update');

    // admin-home-page
    Route::get('admin-home-page', 'Admin\SystemSettings\AramiscSystemSettingController@homePageBackend')->name('admin-home-page')->middleware('userRolePermission:admin-home-page');
    Route::post('admin-home-page-update', 'Admin\SystemSettings\AramiscSystemSettingController@homePageUpdate')->name('admin-home-page-update')->middleware('userRolePermission:admin-home-page-update');
    ...
    // admin-home-page
    Route::get('admin-data-delete', 'Admin\SystemSettings\AramiscSystemSettingController@tableEmpty');
    Route::post('database-delete', 'Admin\SystemSettings\AramiscSystemSettingController@databaseDelete')->name('database-delete');
    Route::get('database-restore', 'Admin\SystemSettings\AramiscSystemSettingController@databaseRestory');
    Route::post('database-restore', 'Admin\SystemSettings\AramiscSystemSettingController@databaseRestory');

    Route::get('change-website-btn-status', 'Admin\SystemSettings\AramiscSystemSettingController@changeWebsiteBtnStatus');
    Route::get('change-dashboard-btn-status', 'Admin\SystemSettings\AramiscSystemSettingController@changeDashboardBtnStatus');
    Route::get('change-report-btn-status', 'Admin\SystemSettings\AramiscSystemSettingController@changeReportBtnStatus');

    Route::get('change-style-btn-status', 'Admin\SystemSettings\AramiscSystemSettingController@changeStyleBtnStatus');
    Route::get('change-ltl_rtl-btn-status', 'Admin\SystemSettings\AramiscSystemSettingController@changeLtlRtlBtnStatus');
    Route::get('change-language-btn-status', 'Admin\SystemSettings\AramiscSystemSettingController@changeLanguageBtnStatus');
    Route::post('update-website-url', 'Admin\SystemSettings\AramiscSystemSettingController@updateWebsiteUrl')->name('update-website-url')->middleware('userRolePermission:update-website-url');

    Route::get('update-created-date', 'Admin\SystemSettings\AramiscSystemSettingController@updateCreatedDate');
    ...
    Route::get('manage-currency', 'Admin\SystemSettings\AramiscSystemSettingController@manageCurrency')->name('manage-currency')->middleware('userRolePermission:manage-currency');
    Route::post('currency-store', 'Admin\SystemSettings\AramiscSystemSettingController@storeCurrency')->name('currency-store')->middleware('userRolePermission:currency-store');
    Route::post('currency-update', 'Admin\SystemSettings\AramiscSystemSettingController@storeCurrencyUpdate')->name('currency-update')->middleware('userRolePermission:currency_edit');
    Route::get('manage-currency/edit/{id}', 'Admin\SystemSettings\AramiscSystemSettingController@manageCurrencyEdit')->name('currency_edit')->middleware('userRolePermission:currency_edit');
    Route::get('manage-currency/delete/{id}', 'Admin\SystemSettings\AramiscSystemSettingController@manageCurrencyDelete')->name('currency_delete')->middleware('userRolePermission:currency_delete');
    Route::get('system-destroyed-by-authorized', 'Admin\SystemSettings\AramiscSystemSettingController@systemDestroyedByAuthorized')->name('systemDestroyedByAuthorized');
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::get('/user-language-change', 'Admin\SystemSettings\AramiscSystemSettingController@ajaxUserLanguageChange');
    ...
    Route::group(['middleware' => ['XSS']], function () {
        Route::get('update-system', 'Admin\SystemSettings\AramiscSystemSettingController@UpdateSystem');
        ...
        Route::get('db-upgrade', 'Admin\SystemSettings\AramiscSystemSettingController@DbUpgrade');
        Route::get('academicIdUpdated', 'Admin\SystemSettings\AramiscSystemSettingController@academicIdUpdated');
        ...
        Route::get('notification-api', 'Admin\SystemSettings\AramiscSystemSettingController@notificationApi')->name('notificationApi');
        ...
        Route::group(['middleware' => ['CheckUserMiddleware']], function () {
            ...
            Route::get('news', 'Admin\SystemSettings\AramiscSystemSettingController@news')->name('news')->middleware('userRolePermission:news');
        });

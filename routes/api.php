...
Route::group(['middleware' => ['XSS', 'auth:api', 'json.response'], 'as' => 'api.'], function () {
    ...
    // Route::get('notification-api', 'AramiscSystemSettingController@notificationApi');

    Route::get('flutter-group-token', 'AramiscApiController@flutterGroupToken');
    //  Route::get('flutter-notification-api', 'AramiscSystemSettingController@flutterNotificationApi');

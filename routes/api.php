...
Route::group(['middleware' => ['XSS', 'auth:api', 'json.response'], 'as' => 'api.'], function () {
    ...
    // Phone Call Log
    Route::resource('phone-call', 'api\ApiAramiscPhoneCallLogController');

    // Admin Setup
    Route::resource('setup-admin', 'api\ApiAramiscSetupAdminController');
    ...
    // ------------------- End Teacher Module------------------
    //--------------------HomwWork ----------------------
    Route::get('homework-list', ['as' => 'homework-list', 'uses' => 'api\ApiAramiscHomeWorkController@homeworkList']);
    Route::get('add-homeworks', 'api\ApiAramiscHomeWorkController@addHomework');
    Route::post('save-homework-data', ['as' => 'saveHomeworkData', 'uses' => 'api\ApiAramiscHomeWorkController@saveHomeworkData']);
    ...
    // Add Expense
    Route::resource('add-expense', 'api\ApiAramiscAddExpenseController');
    ...
    // Staff designation
    Route::resource('designation', 'api\ApiAramiscDesignationController');

    //Department
    Route::resource('department', 'api\ApiAramiscHumanDepartmentController');
    //--------------- End Human Resource  --------------
    ...
    Route::get('approve-leave', 'api\ApiAramiscLeaveController@allAprroveList');
    Route::get('approve-leave/{user_id}', 'api\ApiAramiscLeaveController@userApproveLeave');
    Route::get('school/{school_id}/approve-leave', 'SmApiController@saas_Approve_Leave_index');
    Route::post('approve-leave-store', 'api\ApiAramiscLeaveController@leaveApprove');
    ...
    //Student leave
    Route::get('student-apply-leave/{user_id}', 'api\ApiAramiscLeaveController@studentleaveApply');
    Route::post('student-apply-leave-store', 'api\ApiAramiscLeaveController@leaveStoreStudent');
    Route::get('school/{school_id}/student-apply-leave', 'Parent\AramiscParentPanelController@saas_leaveApply');
    Route::get('student-view-leave-details-apply/{id}', 'Parent\AramiscParentPanelController@viewLeaveDetails');
    Route::get('student-apply-leave-edit/{id}', 'Parent\AramiscParentPanelController@parentLeaveEdit');
    Route::post('student-apply-leave-update', 'Parent\AramiscParentPanelController@update');
    // Route::post('student-apply-leave-store', 'Parent\AramiscParentPanelController@leaveStore');
    Route::get('student-delete-apply-leave/{id}', 'Parent\AramiscParentPanelController@DeleteLeave');
    Route::get('my-leave-type/{user_id}', 'api\ApiAramiscLeaveController@myLeaveType');

    //End student leave

    // Staff leave define
    Route::resource('leave-define', 'api\ApiAramiscLeaveDefineController');

    // Staff leave type
    Route::resource('leave-type', 'api\ApiAramiscLeaveTypeController');
    ...
    // Marks Grade
    Route::resource('marks-grade', 'api\ApiAramiscMarksGradeController');
    ...
    Route::post('class-routine-new', 'api\ApiAramiscClassRoutineController@classRoutineSearch');
    Route::post('add-new-class-routine-store', 'api\ApiAramiscClassRoutineController@addNewClassRoutineStore');
    Route::get('student-routine-view/{student_id}/{record_id}', 'api\ApiAramiscClassRoutineController@studentClassRoutine');
    Route::get('teacher-routine-view/{techer_id}', 'api\ApiAramiscClassRoutineController@teacherClassRoutine');
    Route::get('class-routine-view/{user_id}/{record_id}', 'api\ApiAramiscClassRoutineController@studentClassRoutine')->middleware('subdomain');
    Route::post('day-wise-class-routine', 'api\ApiAramiscClassRoutineController@dayWiseClassRoutine')->name('dayWise_class_routine');
    ...
    Route::resource('assign-class-teacher', 'api\ApiAramiscAssignClassTeacherControler');
    ...
    // Class room
    Route::resource('class-room', 'api\ApiAramiscClassRoomController');

    //class time
    Route::resource('class-time', 'api\ApiAramiscClassTimeController');
    ...
    //homework list
    Route::get('homework-list/{user_id}', ['uses' => 'api\ApiAramiscHomeWorkController@homeworkList']);
    Route::get('school/{school_id}/homework-list', ['as' => 'saas_homework-list', 'uses' => 'api\ApiAramiscHomeWorkController@saas_homeworkList']);
    Route::post('homework-list', ['as' => 'homework-list_post', 'uses' => 'api\ApiAramiscHomeWorkController@searchHomework']);
    Route::post('school/{school_id}/homework-list', ['as' => 'saas_homework-list_post', 'uses' => 'SmApiController@saas_searchHomework']);
    Route::get('evaluation-homework/{class_id}/{section_id}/{homework_id}', ['as' => 'evaluation-homework', 'uses' => 'api\ApiAramiscHomeWorkController@evaluationHomework']);

    Route::get('school/{school_id}/evaluation-homework/{class_id}/{section_id}/{homework_id}', ['as' => 'saas-evaluation-homework', 'uses' => 'api\ApiAramiscHomeWorkController@saas_evaluationHomework']);

    Route::post('evaluate-homework', ['as' => 'evaluate-homework', 'uses' => 'api\ApiAramiscHomeWorkController@saveHomeworkEvaluationData']);
    Route::post('school/{school_id}/evaluate-homework', ['as' => 'saas-evaluate-homework', 'uses' => 'api\ApiAramiscHomeWorkController@saasSaveHomeworkEvaluationData']);


    Route::any('add-homework', 'api\ApiAramiscHomeWorkController@addHomework');
    Route::post('update-homework', 'api\ApiAramiscHomeWorkController@homeworkUpdate');
    Route::any('saas-add-homework', 'api\ApiAramiscHomeWorkController@saas_addHomework');
    Route::get('school/{school_id}/homework-list/{id}', 'api\ApiAramiscHomeWorkController@saas_homework_List_Teacher');
    //--------------- End Homework Module--------------
    ...
    //library member
    Route::resource('library-member', 'api\ApiAramiscLibraryMemberController');
    Route::post('add-library-member', 'api\ApiAramiscLibraryMemberController@library_member_store');
    Route::post('saas-add-library-member', 'api\ApiAramiscLibraryMemberController@saas_library_member_store');
    ...
    //Supplier
    Route::resource('suppliers', 'api\ApiAramiscSupplierController');
    ...
    //Vehicle
    Route::resource('vehicle', 'api\ApiSmAramiscVehicleController');
    Route::resource('saas-vehicle', 'api\SaasVehicleController');

    //Assign Vehicle
    Route::resource('assign-vehicle', 'api\ApiAramiscAssignVehicleController');
    ...
    Route::post('class-routine-report', 'api\ApiAramiscClassRoutineController@classRoutineReportSearch');
    ...
    Route::post('teacher-class-routine-report', 'api\ApiAramiscClassRoutineController@teacherClassRoutineReportSearch');
    ...
    //weekend
    Route::resource('weekend', 'api\ApiAramiscWeekendController');
    ...
    Route::get('student-homework/{user_id}/{record_id}', 'api\ApiAramiscHomeWorkController@studentHomework');
    Route::post('student-upload-homework', 'api\ApiAramiscHomeWorkController@studentUploadHomework');
    Route::get('school/{school_id}/student-homework/{user_id}/{record_id}', 'api\ApiAramiscHomeWorkController@saas_studentHomework');
    Route::post('school/{school_id}/student-upload-homework', 'api\ApiAramiscHomeWorkController@saas_studentUploadHomework');
    ...
    Route::get('child-list/{id}', 'api\ApiAramiscParentPanelController@childListApi');
    Route::get('school/{school_id}/child-list/{id}', 'api\ApiAramiscParentPanelController@saas_childListApi');
    ...
    Route::get('childInfo/{id}', 'api\ApiAramiscParentPanelController@childInfo');
    Route::get('school/{school_id}/childInfo/{id}', 'api\ApiAramiscParentPanelController@saas_childInfo');

    Route::get('parent-about', 'SmApiController@aboutApi');
    Route::get('school/{school_id}/parent-about', 'SmApiController@saas_aboutApi');


    //Route::get('parent-about', 'Parent\AramiscParentPanelController@aboutApi');
    ...
    // https://aramiscedu.com/api/search-student?class=2
    // https://aramiscedu.com/api/search-student?section=1&class=2
    // https://aramiscedu.com/api/search-student?name=Conner Stamm
    // https://aramiscedu.com/api/search-student?roll_no=28229
    ...
    Route::get('my-attendance/{id}', 'api\ApiAramiscStaffAttendanceController@teacherMyAttendanceSearchAPI');
    Route::get('school/{school_id}/my-attendance/{id}', 'api\ApiAramiscStaffAttendanceController@saas_teacherMyAttendanceSearchAPI');
    ...
    Route::get('pending-leave/{user_id}', 'api\ApiAramiscLeaveController@pendingLeave');

    //Super Admin Api
    Route::get('pending-leave', 'api\ApiAramiscLeaveController@allPendingList');
    ...
    Route::get('reject-leave', 'api\ApiAramiscLeaveController@allRejectedList');
    Route::get('reject-leave/{user_id}', 'api\ApiAramiscLeaveController@rejectUserLeave');
    Route::get('school/{school_id}/reject-leave', 'api\ApiAramiscLeaveController@saas_rejectLeave');
    ...
    //aramiscedu.com/android/api/group-token?id=2&body=Notification body&title=Notification title
    ...
    Route::get('homework-notification-api', 'api\ApiAramiscHomeWorkController@HomeWorkNotification');
    ...
    Route::get('my-leave-type/{school_id}/{user_id}', 'api\ApiAramiscLeaveController@saas_myLeaveType');
    // update 1-14-2-2022
    ...
    //class routine
    Route::get('student-class-routine/{user_id}/{record_id}', 'api\ApiAramiscClassRoutineController@studentClassRoutine');
    Route::get('school/{school_id}/student-class-routine/{user_id}/{record_id}', 'api\ApiAramiscClassRoutineController@sassclassRoutine');

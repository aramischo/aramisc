...
class AramiscTeacherUploadContent extends Model
{
    use HasFactory;
    // Spécifiez le nom de la table explicitement
    protected $table = 'aramisc_teacher_upload_contents';
    ...
    {
        return $this->belongsTo('App\AramiscSection', 'section', 'id');
    }
    public function globalSections()
    {
        return $this->belongsTo('App\AramiscSection', 'section', 'id')->withoutGlobalScope(StatusAcademicSchoolScope::class)->withoutGlobalScope(GlobalAcademicScope::class);
    }
    ...
    {
        return $this->belongsTo('App\AramiscSection', 'un_section_id', 'id')->withDefault();
    }

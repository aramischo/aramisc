...
class ApiAramiscLeaveDefineController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try{
            ...
            $leave_defines = AramiscLeaveDefine::where('active_status', 1)->get();
    ...
    public function store(Request $request)
    {
        ...
        try{
            $leaves = AramiscLeaveDefine::where('role_id', $request->role)->where('type_id', $request->leave_type)->first();
    ...
    public function destroy(Request $request, $id)
    {
        ...
        try{
            ...
            //return $tables;
            try {
                $result = AramiscLeaveDefine::destroy($id);

...
class ZoomController extends Controller
{
    ...
    public function updateMeeting(Request $request)
    {
        ...
        $GSetting = AramiscGeneralSettings::where('school_id', $creator_info->school_id)->first();
    ...
    {
        $sections = AramiscClassSection::with('sectionName')->where('class_id', $request->class_id)

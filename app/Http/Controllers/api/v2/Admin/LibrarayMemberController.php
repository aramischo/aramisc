...
class LibrarayMemberController extends Controller
{
    ...
    public function studentList(Request $request)
    {
        ...
        $students = AramiscStudent::withoutGlobalScope(SchoolScope::class)->with('parents')
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($request->student)) {
            $student = AramiscStudent::where('id', $request->student)->where('school_id', auth()->user()->school_id)->first();

...
class BookController extends Controller
{
    ...
    {
        $categories = AramiscBookCategory::withoutGlobalScope(AcademicSchoolScope::class)
    ...
    public function storeBook(Request $request)
    {
        ...
        // $data = AramiscBook::select('id','book_title','book_category_id','book_number','isbn_no','publisher_name','author_name','book_subject_id','rack_number','quantity','book_price','details','post_date')->find($books->id);

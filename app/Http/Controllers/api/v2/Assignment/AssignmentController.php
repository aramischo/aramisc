...
class AssignmentController extends Controller
{
    public function studentAssignment(Request $request)
    {
        ...
        $assignment = AramiscTeacherUploadContent::withoutGlobalScope(GlobalAcademicScope::class)
    ...
    {
        $homeworkDetails = AramiscTeacherUploadContent::select('upload_file')->find($id);
    ...
    {
        $data = AramiscTeacherUploadContent::withoutGlobalScope(GlobalAcademicScope::class)

...
class ExamController extends Controller
{
    public function studentExam(Request $request)
    {
        ...
        $exam = AramiscExam::withoutGlobalScopes([AcademicSchoolScope::class, GlobalAcademicScope::class])
    ...
    public function studentExamType(Request $request)
    {
        ...
        $exam = AramiscExamType::withoutGlobalScopes([StatusAcademicSchoolScope::class, GlobalAcademicScope::class])
            ->select('id', 'title')
            ->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())
    ...
    public function studentExamSchedule(Request $request)
    {
        ...
        $schedule = AramiscExamSchedule::withoutGlobalScope(AcademicSchoolScope::class)
    ...
    public function examResult(Request $request)
    {
        ...
        $get_results = AramiscStudent::getExamResult(@$exam->id, @$record);
    ...
    {
        $result = AramiscStudentTakeOnlineExam::where('active_status', 1)
            ->where('status', 2)
            ->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())

...
class ApiAramiscAcademicYearController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            $academic_years = AramiscAcademicYear::where('active_status', 1)->orderBy('year', 'ASC')->get();
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($input, [
            'year' => 'required|numeric|between:2019,3000|unique:aramisc_academic_years,year',
    ...
    public function update(Request $request, $id)
    {
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            $validator = Validator::make($input, [
                'year' => 'required|numeric|between:2019,3000|unique:aramisc_academic_years,year,' . $id,
                'title' => "required|max:150",
    ...
    public function destroy(Request $request, $id)
    {
        ...
        try {
            ...
            try {
                $delete_query = AramiscAcademicYear::destroy($id);
                if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                    if ($delete_query) {

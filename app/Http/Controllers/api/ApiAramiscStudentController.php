...
class ApiAramiscStudentController extends Controller
{
    public function searchStudent(Request $request)
    {
        ...
        $studentDetails = AramiscStudent::whereIn('id', $student_ids)
            ->when($request->name, function ($q) use ($request) {
                $q->where('full_name', 'like', '%' . $request->name . '%');
            })->get();
        // ->select('aramisc_students.id', 'student_photo', 'full_name', 'roll_no', 'user_id');

...
class ApiSmAramiscVehicleController extends Controller
{
    ...
    {
        try {
            $drivers = AramiscStaff::where([['active_status', 1], ['role_id', 9]])->get();
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($input, [
            'vehicle_number' => "required|unique:aramisc_vehicles,vehicle_no|max:200",
    ...
    public function update(Request $request, $id)
    {
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            $validator = Validator::make($input, [
                'vehicle_number' => 'required|max:200|unique:aramisc_vehicles,vehicle_no,' . $id,
                'vehicle_model' => "required|max:200",
                'year_made' => "sometimes|nullable|max:10",
                'id' => 'required',
            ]);

...
class ApiAramiscDesignationController extends Controller
{
    ...
    {
        try{
            $designations = AramiscDesignation::where('active_status', 1)->get();
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($input, [
            'title' => "required|max:200|unique:aramisc_designations,title"
        ]);
    ...
    public function show(Request $request, $id)
    {
        try{
            ...
            $designations = AramiscDesignation::all();
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                $data = [];
    ...
    public function destroy(Request $request, $id)
    {
        try{
            ...
            try {
                $delete_query = AramiscDesignation::destroy($id);
                if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                    if ($delete_query) {

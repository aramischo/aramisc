...
class AramiscApiController extends Controller
{
            ...
            foreach ($lastest_data as $device_log) {
                ...
                if ($user_table) {
                    if ($user_table->role_id == 2) {
                        ...
                        $attendance = AramiscStudentAttendance::where('student_id', $sm_students->id)->where('attendance_date', date('Y-m-d', strtotime($device_log->checktime)))->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->first();
                        if ($attendance == "") {
                        ...
                        $attendance->academic_id = AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR();
                        $attendance->save();
                    } else {
    ...
    public function postal_dispatch_show(Request $request, $id)
    {
        ...
        try {
            $postal_dispatchs = SmPostalDispatch::where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
    ...
    public function saas_postal_dispatch_show(Request $request, $school_id, $id)
    {
        ...
        try {
            $postal_dispatchs = SmPostalDispatch::where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where('school_id', $school_id)->get();
    ...
    public function studentDetails(Request $request)
    {
        try {
            ...
            $student_list = DB::table('sm_students')
                ...
                ->where('sm_students.academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())
                ->get();
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                $data = [];
                ...
                try {
                    ...
                    foreach ($request->id as $student_id) {
                        ...
                        if ($request->result[$student_id] == 'P') {
                            $merit_list = \App\SmTemporaryMeritlist::where(['student_id' => $student_id, 'class_id' => $request->current_class, 'section_id' => $student_details->section_id])->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->first();
    ...
    public function uploadContentList(Request $request)
    {
        ...
        try {
            $contentTypes = SmContentType::where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
    ...
    public function saas_uploadContentList(Request $request, $school_id)
    {
        ...
        try {
            $contentTypes = SmContentType::where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where('school_id', $school_id)->get();
    ...
    public function saveUploadContent(Request $request)
    {
        ...
        try {
            ...
            foreach ($request->available_for as $value) {
                if ($value == 'admin') {
                    $roles = InfixRole::where('id', '=', 1) /* ->where('id', '!=', 2)->where('id', '!=', 3)->where('id', '!=', 9) */->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where(function ($q) {
                        $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
                    })->get();
                    foreach ($roles as $role) {
                        $staffs = SmStaff::where('role_id', $role->id)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
    ...
    public function saas_collectFeesStudentApi(Request $request, $school_id, $id)
    {
        try {
            ...
            $fees_assigneds = AramiscFeesAssign::where('student_id', $id)->where('school_id', $school_id)->orderBy('id', 'desc')->get();
    ...
    public function saas_fees_group_edit(Request $request, $school_id, $id)
    {
        ...
        try {
            $fees_group = AramiscFeesGroup::where('school_id', $school_id)->find($id);
            $fees_groups = AramiscFeesGroup::where('school_id', $school_id)->get();
    ...
    public function fees_group_update(Request $request)
    {
        ...
        try {
            $visitor = AramiscFeesGroup::find($request->id);
            $visitor->name = $request->name;
            $visitor->description = $request->description;
            $result = $visitor->save();
    ...
    public function saas_fees_group_update(Request $request, $school_id)
    {
        ...
        try {
            $visitor = AramiscFeesGroup::where('school_id', $request->school_id)->find($request->id);
            $visitor->name = $request->name;
            $visitor->description = $request->description;
            $visitor->school_id = $school_id;
            $result = $visitor->save();
    ...
    public function saas_fees_group_delete(Request $request, $school_id)
    {
        ...
        try {
            $fees_group = AramiscFeesGroup::where('school_id', $school_id)->where('id', $request->id)->delete();
    ...
    public function subject_edit(Request $request, $id)
    {
        ...
        try {
            ...
            $subjects = SmSubject::where('active_status', 1)->orderBy('id', 'DESC')->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
    ...
    public function saas_subject_edit(Request $request, $school_id, $id)
    {
        ...
        try {
            ...
            $subjects = SmSubject::where('active_status', 1)->orderBy('id', 'DESC')->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where('school_id', $school_id)->get();
    ...
    public function class_index(Request $request)
    {
        try {
            $sections = AramiscSection::where('active_status', '=', 1)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
            $classes = SmClass::where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where('active_status', '=', 1)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
    ...
    public function saas_class_index(Request $request, $school_id)
    {
        try {
            $sections = AramiscSection::where('active_status', '=', 1)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where('school_id', $school_id)->get();
            $classes = SmClass::where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where('active_status', '=', 1)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where('school_id', $school_id)->get();
    ...
    public function class_edit(Request $request, $id)
    {
        ...
        try {
            ...
            $sectionByNames = SmClassSection::select('section_id')->where('class_id', '=', $classById->id)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
            ...
            $classes = SmClass::where('active_status', '=', 1)->orderBy('id', 'desc')->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
    ...
    public function saas_class_edit(Request $request, $school_id, $id)
    {
        ...
        try {
            ...
            $sectionByNames = SmClassSection::select('section_id')->where('class_id', '=', $classById->id)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where('school_id', $school_id)->get();
            ...
            $classes = SmClass::where('active_status', '=', 1)->orderBy('id', 'desc')->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where('school_id', $school_id)->get();
    ...
    public function class_Routine(Request $request, $id = null)
    {
        ...
        $class_times = SmClassTime::where('type', 'class')->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            foreach ($weekenD as $row) {
                $data[$row->name] = DB::table('sm_class_routine_updates')
                    ...
                    ])->where('sm_class_routine_updates.academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
            }
    ...
    public function saas_class_Routine(Request $request, $school_id, $id = null)
    {
        ...
        $sm_weekends = SmWeekend::orderBy('order', 'ASC')->where('active_status', 1)->where('academic_id', AramiscAcademicYear::API_ACADEMIC_YEAR($school_id))->where('school_id', $student_detail->school_id)->get();
        $class_times = SmClassTime::where('type', 'class')->where('academic_id', AramiscAcademicYear::API_ACADEMIC_YEAR($school_id))->where('school_id', $school_id)->get();
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            foreach ($weekenD as $row) {
                $data[$row->name] = DB::table('sm_class_routine_updates')
                    ...
                    ->where([
                        ['sm_class_routine_updates.class_id', $class_id], ['sm_class_routine_updates.section_id', $section_id], ['sm_class_routine_updates.day', $row->id],
                    ])->where('sm_class_routine_updates.academic_id', AramiscAcademicYear::API_ACADEMIC_YEAR($school_id))
    ...
    public function sendEmailSmsView(Request $request)
    {
        try {
            ...
            $classes = SmClass::where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
    ...
    public function saas_sendEmailSmsView(Request $request, $school_id)
    {
        try {
            ...
            $classes = SmClass::where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where('school_id', $school_id)->get();
    ...
    public function saas_updateBookData(Request $request, $id)
    {
        ...
        try {
            ...
            $books = AramiscBook::where('school_id', $school_id)->find($id);
            $books->book_title = $request->book_title;
            $books->book_category_id = $request->book_category_id;
            $books->book_number = $request->book_number;
            $books->isbn_no = $request->isbn_no;
    ...
    {
        try {
            $classes = SmClass::where('active_status', 1)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())
                ->get();
    ...
    {
        try {
            $classes = SmClass::where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where('active_status', 1)->get();
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                return ApiBaseMethod::sendResponse($classes, null);
            }
    ...
    public function classReportSearch(Request $request)
    {
        ...
        try {
            $class = SmClass::where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where('id', $request->class)->first();
            if ($request->section != "") {
    ...
    public function examRoutineReportSearch(Request $request)
    {
        ...
        try {
            ...
            $exam_periods = SmClassTime::where('type', 'exam')->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
    ...
    public function meritListReportSearch(Request $request)
    {
        try {
            ...
            if ($request->method() == 'POST') {
                ...
                $subjects = SmSubject::where('active_status', 1)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
                $assign_subjects = SmAssignSubject::where('class_id', $class->id)->where('section_id', $section->id)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
                $class_name = $class->class_name;

                $exam_name = $exam->title;

                $eligible_subjects = SmAssignSubject::where('class_id', $InputClassId)->where('section_id', $InputSectionId)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
                ...
                $allresult_data = SmTemporaryMeritlist::where('iid', $iid)->orderBy('gpa_point', 'desc')->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
                $merit_serial = 1;
                ...
                $allresult_data = SmTemporaryMeritlist::orderBy('merit_order', 'asc')->where('exam_id', '=', $InputClassId)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
    ...
    public function onlineExamReport(Request $request)
    {
        ...
        try {
            $exams = SmOnlineExam::where('active_status', 1)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
            $classes = SmClass::where('active_status', 1)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
    ...
    public function markSheetReportStudentSearch(Request $request)
    {
        ...
        try {
            ...
            $subjects = SmAssignSubject::where([['class_id', $request->class], ['section_id', $request->section]])->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
            ...
            $subjects = SmAssignSubject::where('class_id', $request->class)->where('section_id', $request->section)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
            $exams = AramiscExamType::where('active_status', 1)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
            $classes = SmClass::where('active_status', 1)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
            $grades = SmMarksGrade::where('active_status', 1)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
    ...
    public function markSheetReportStudent_Search(Request $request)
    {
        ...
        try {
            ...
            $is_result_available = SmResultStore::where([['class_id', $request->class], ['exam_type_id', $request->exam], ['section_id', $request->section], ['student_id', $request->student]])->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
    ...
    public function tabulationSheetReportSearch(Request $request)
    {
        ...
        try {
            ...
            if ($request->student == "") {
                $eligible_subjects = SmAssignSubject::where('class_id', $class_id)->where('section_id', $section_id)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
            ...
            if ($request->student != '') {
                ...
                $grade_chart = SmMarksGrade::select('grade_name', 'gpa', 'percent_from as start', 'percent_upto as end', 'description')->where('active_status', 1)->where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get()->toArray();
    ...
    {
        try {
            $user_logs = SmUserLog::where('academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
    ...
    public function studentSubjectApi(Request $request, $id)
    {
        ...
        $assignSubjects = DB::table('sm_assign_subjects')
            ...
            ->where('sm_assign_subjects.academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            $data = [];
    ...
    public function saas_studentSubjectApi(Request $request, $school_id, $id)
    {
        ...
        $assignSubjects = DB::table('sm_assign_subjects')
            ...
            ->where('sm_assign_subjects.class_id', '=', @$student->class_id)
            ->where('sm_assign_subjects.section_id', '=', @$student->section_id)
            ->where('sm_assign_subjects.academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where('sm_assign_subjects.school_id', $school_id)->get();
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            $data = [];
            $data['student_subjects'] = $assignSubjects->toArray();
            return ApiBaseMethod::sendResponse($data, null);
    ...
    public function studentAssignmentApi(Request $request, $id)
    {
        ...
        $student_detail = AramiscStudent::where('user_id', $id)->first(['id', 'full_name', 'admission_no', 'email', 'mobile', 'class_id', 'section_id']);
    ...
    public function studentExamScheduleApi(Request $request, $id)
    {
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            $exam_schedule = DB::table('sm_exam_schedules')
                ...
                ->where('sm_exam_schedules.academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
    ...
    public function saas_studentExamScheduleApi(Request $request, $school_id, $id)
    {
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            $exam_schedule = DB::table('sm_exam_schedules')
                ...
                ->where('sm_exam_schedules.section_id', '=', @$student_detail->section_id)
                ->where('sm_exam_schedules.academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->
    ...
    public function studentTimelineApi(Request $request, $id)
    {
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            $timelines = DB::table('sm_student_timelines')
                ...
                ->where('sm_student_timelines.academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->get();
    ...
    public function saas_studentTimelineApi(Request $request, $school_id, $id)
    {
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            $timelines = DB::table('sm_student_timelines')
                ...
                ->where('sm_student_timelines.academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->
        ...
        try {
            ...
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                ...
                $online_exams = SmOnlineExam::where('active_status', 1)
                    ->where('academic_id', AramiscAcademicYear::API_ACADEMIC_YEAR($student->school_id))
                ...
                $online_exams = SmOnlineExam::where('sm_online_exams.active_status', 1)
                    ->where('sm_online_exams.academic_id', AramiscAcademicYear::API_ACADEMIC_YEAR($student->school_id))
    ...
    public function saas_childInfo(Request $request, $school_id, $user_id)
    {
        ...
        try {
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                ...
                $user = AramiscStudent::where('user_id', $user_id)->where('school_id', $school_id)->first();
                $data = [];
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            if ($teacher->role_id == 1) {
                ...
                $teacher_classes = DB::table('sm_assign_subjects')
                    ...
                    ->where('teacher_id', $teacher_id)
                    ->where('sm_classes.academic_id', AramiscAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())
                    ->get();
            }
    ...
    {
        try {
            $students = AramiscStudent::where('class_id', $request->class_id)->where('section_id', $request->section_id)->get();

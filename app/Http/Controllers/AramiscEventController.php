...
class AramiscEventController extends Controller
{
    ...
    {
        try {
            $events = AramiscEvent::where('school_id', Auth::user()->school_id)->where('academic_id', getAcademicId())->orderby('id','DESC')->get();
    ...
    public function edit(Request $request, $id)
    {
        try {
             if (checkAdmin()) {
                ...
                $editData = AramiscEvent::where('id',$id)->where('school_id',Auth::user()->school_id)->first();
            }
            $events = AramiscEvent::where('school_id', Auth::user()->school_id)->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if (checkAdmin()) {
                ...
                $events = AramiscEvent::where('id',$id)->where('school_id',Auth::user()->school_id)->first();
            }
    ...
    public function deleteEvent(Request $request, $id)
    {
        ...
        try {
            if (checkAdmin()) {
                $events = AramiscEvent::destroy($id);
            }else{
                $events = AramiscEvent::where('id',$id)->where('school_id',Auth::user()->school_id)->delete();
            }

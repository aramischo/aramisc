...
class AramiscVisitorController extends Controller
{
    ...
    {
        try {
            $visitors = AramiscVisitor::where('school_id',Auth::user()->school_id)->where('academic_id', getAcademicId())->orderby('id','DESC')->get();
    ...
    public function edit(Request $request, $id)
    {
        ...
        try{
             if (checkAdmin()) {
                ...
                $visitor = AramiscVisitor::where('id',$id)->where('school_id',Auth::user()->school_id)->first();
            }

            $visitors = AramiscVisitor::where('school_id',Auth::user()->school_id)->get();
        ...
        try{
            ...
            $newformat = date('Y-m-d', $time);
             ...
             if (checkAdmin()) {
                ...
                $visitor = AramiscVisitor::where('id',$request->id)->where('school_id',Auth::user()->school_id)->first();
            }
            $visitor->name = $request->name;
            $visitor->phone = $request->phone;
            $visitor->visitor_id = $request->visitor_id;

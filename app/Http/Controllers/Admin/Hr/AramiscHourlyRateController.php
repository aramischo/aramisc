...
class AramiscHourlyRateController extends Controller
{
    ...
    public function index()
    {
        ...
        try{
            $hourly_rates = AramiscHourlyRate::all();
    ...
    public function store(Request $request)
    {
        ...
        try{
            $hourly_rate = new AramiscHourlyRate();
    ...
    public function show($id)
    {
        ...
        try{
            $hourly_rate = AramiscHourlyRate::find($id);
            $hourly_rates = AramiscHourlyRate::all();
    ...
    public function update(Request $request, $id)
    {
        ...
        try{
            $hourly_rate = AramiscHourlyRate::find($request->id);
            $hourly_rate->grade = $request->grade;
            $hourly_rate->rate = $request->rate;
            $result = $hourly_rate->save();
            if($result){
    ...
    public function destroy($id)
    {
        ...
        try{
            $hourly_rate = AramiscHourlyRate::destroy($id);
            if($hourly_rate){
                Toastr::success('Operation successful', 'Success');
                return redirect('hourly-rate');

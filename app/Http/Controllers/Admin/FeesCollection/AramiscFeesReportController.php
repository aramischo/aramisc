...
class AramiscFeesReportController extends Controller
{
       ...
       if(!moduleStatusCheck('University')){
        ...
        try {
            ...
            elseif(directFees()){
                ...
                $students = AramiscStudent::with('parents', 'feesAssign', 'feesAssign.feesGroupMaster', 'feesAssign.feesPayments', 'feesPayment')->whereIn('id', $student_ids)->get();
                $balance_students = [];

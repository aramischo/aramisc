...
class AramiscSearchFeesPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            if(auth()->user()->role_id ==1 || auth()->user()->role_id ==5){
                $fees_payments = AramiscFeesPayment::with('recordDetail','installmentPayment','recordDetail.studentDetail','recordDetail.class','recordDetail.section')

...
class AramiscFeesBankPaymentController extends Controller
{
    ...
    public function bankPaymentSlipSearch(AramiscFeesBankPaymentRequest $request)
    {
        try {
        ...
        try {
          if (checkAdmin()) {
            ...
            elseif(directFees()){
                ...
                $fees_assign=AramiscFeesAssign::where('fees_master_id',$get_master_id->fees_master_id)

...
use App\Http\Requests\Admin\Examination\AramiscExamFormatSettingsRequest;

class AramiscExamFormatSettingsController extends Controller
{
    ...
    {
        try {
            $content_infos = AramiscExamSetting::with('examName')->get();
    ...
    public function store(AramiscExamFormatSettingsRequest $request)
    {
    ...
    public function edit($id)
    {
        try {
            ...
            $editData = AramiscExamSetting::where('id', $id)->first();
    ...
    public function update(AramiscExamFormatSettingsRequest $request)
    {
    ...
    public function allExamReportPositionStore(Request $request)
    {
        try {
            ...
            $examTerm = AramiscExam::where('class_id', $class)
                ->where('section_id', $section)
                ->where('academic_id', getAcademicId())
                ->where('school_id', Auth::user()->school_id)

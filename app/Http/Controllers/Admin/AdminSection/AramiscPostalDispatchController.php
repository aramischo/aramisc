...
use App\Http\Requests\Admin\AdminSection\AramiscPostalDispatchRequest;


class AramiscPostalDispatchController extends Controller
{
    ...
    public function store(AramiscPostalDispatchRequest $request)
    {
        try{
    ...
    public function update(AramiscPostalDispatchRequest $request)
    {
        try{
            $destination='public/uploads/postal/' ;
    ...
    {
        try {
            $postal_dispatchs = AramiscPostalDispatch::query();

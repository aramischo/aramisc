...
class AramiscStudentIdCardController extends Controller
{
    ...
    public function store(AramiscStudentIdCardRequest $request)
    {
        try {
    ...
    public function update(AramiscStudentIdCardRequest $request, $id)
    {
        try {
            $destination='public/uploads/studentIdCard/';  
    ...
    public function generateIdCardBulk(Request $request)
    {
        ...
        if ($request->role==2) {
            $s_students = AramiscStudent::when($request->class, function($q) use($request){

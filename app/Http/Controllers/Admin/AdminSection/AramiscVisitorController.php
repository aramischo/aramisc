...
class AramiscVisitorController extends Controller
{
    ...
    public function store(AramiscVisitorRequest $request)
    {
        try {
    ...
    public function edit(Request $request, $id)
    {
        try {
            ...
            $visitors = AramiscVisitor::orderby('id', 'DESC')->get();
    ...
    public function update(AramiscVisitorRequest $request)
    {
        try {
            $destination = 'public/uploads/visitor/';

...
class AramiscAddOnsController extends Controller
{
        ...
        if (Config::get('app.app_pro')) {
            try {
                ...
                if (!empty($product_info->products[0])) {
                    ...
                    if (!Schema::hasColumn('aramisc_general_settings', $name)) {
                        Schema::table('aramisc_general_settings', function ($table) use ($name) {
                    ...
                    try {
                        ...
                        $config = AramiscGeneralSettings::first();
                        $config->$name = 1;
                        $r = $config->save();

...
class AramiscOptionalSubjectAssignController extends Controller
{
    ...
    public function optionalSetup(Request $request)
    {
        ...
        try {
            ...
            $class_optionals = AramiscClassOptionalSubject::join('aramisc_classes', 'aramisc_classes.id', '=', 'aramisc_class_optional_subject.class_id')
                ->select('aramisc_class_optional_subject.*', 'class_name')
                ->where('aramisc_class_optional_subject.school_id', Auth::user()->school_id)
                ->where('aramisc_class_optional_subject.academic_id', getAcademicId())
                ->orderby('aramisc_class_optional_subject.id', 'DESC')
                ->get();
    ...
    public function optionalSetupEdit($id)
    {
        ...
        try {
            ...
            $classes = AramiscClass::where('active_status', 1)->where('school_id', Auth::user()->school_id)->where('aramisc_classes.academic_id', getAcademicId())->get();
            //    return $classes;
            $class_optionals = AramiscClassOptionalSubject::join('aramisc_classes', 'aramisc_classes.id', '=', 'aramisc_class_optional_subject.class_id')
                ->select('aramisc_class_optional_subject.*', 'class_name')
                ->where('aramisc_class_optional_subject.school_id', Auth::user()->school_id)->get();

...
class AramiscStudentGroupController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            $student_groups = AramiscStudentGroup::withCount('students')->where('school_id', Auth::user()->school_id)->get();
    ...
    public function delete(Request $request, $id)
    {
        ...
        try {
            ...
            try {
                if ($tables == null) {
                    AramiscStudentGroup::destroy($id);

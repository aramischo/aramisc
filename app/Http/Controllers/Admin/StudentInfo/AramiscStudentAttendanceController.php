...
use App\Http\Requests\Admin\StudentInfo\AramiscStudentAttendanceSearchRequest;
...
class AramiscStudentAttendanceController extends Controller
{
    ...
    public function studentSearch(AramiscStudentAttendanceSearchRequest $request)
    {
    ...
    public function studentAttendanceStore(Request $request)
    {
        try {
            ...
            foreach ($request->attendance as $record_id => $student) {
                ...
                //     $student_detail = AramiscStudent::find(gv($student, 'student'));
                //     if ($student) {
                        ...
                        if ($value != "") {
                            if (date('d/m/Y', strtotime($request->attendance_date)) == date('d/m/Y', strtotime($value->attendance_date))) {
                                ...
                                if ($student != "") {
                                    ...
                                    $attendance_check = AramiscStudentAttendance::where('student_record_id', $student->id)

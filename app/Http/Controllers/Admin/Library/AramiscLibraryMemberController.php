...
class AramiscLibraryMemberController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            $libraryMembers = AramiscLibraryMember::with('roles', 'studentDetails', 'staffDetails', 'parentsDetails', 'memberTypes')->where('active_status', '=', 1)
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($request->student)) {
            ...
            $isData = AramiscLibraryMember::where('student_staff_id', '=', $student_staff_id)->first();
            if (!empty($isData)) {
        ...
        try {
            ...
            $isExitMember = AramiscLibraryMember::where('student_staff_id', $student_staff_id)->withoutGlobalScopes()->status()->first();

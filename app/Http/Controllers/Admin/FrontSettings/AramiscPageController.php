...
use App\Http\Requests\Admin\FrontSettings\AramiscPageRequest;
use App\Http\Requests\Admin\FrontSettings\ExamResultPageRequest;

class AramiscPageController extends Controller
{
    ...
    public function update(AramiscPageRequest $request)
    {
        try {
            $destination = 'public/uploads/pages/';

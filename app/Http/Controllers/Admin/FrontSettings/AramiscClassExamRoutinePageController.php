...
class AramiscClassExamRoutinePageController extends Controller
{
    ...
    public function classExamRoutinePageUpdate(Request $request)
    {
        try {
            ...
            $routinePage = AramiscClassExamRoutinePage::where('school_id', app('school')->id)->first();
            ...
            if ($routinePage) {
                ...
                $routinePage = new AramiscClassExamRoutinePage();

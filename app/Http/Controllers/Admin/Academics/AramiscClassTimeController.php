...
use App\Http\Requests\Admin\Academics\AramiscClassTimeRequest;

class AramiscClassTimeController extends Controller
{
    ...
    {
        try {
            $class_times = AramiscClassTime::where('type','class')->latest()->get();
    ...
    public function store(AramiscClassTimeRequest $request)
    {
    ...
    public function update(AramiscClassTimeRequest $request, $id)
    {
    ...
    public function examTime(Request $request){
        try {
            $class_times = AramiscClassTime::where('type','exam')->latest()->get();
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                return ApiBaseMethod::sendResponse($class_times, null);
            }
    ...
    {
        try {
            $class_time = AramiscClassTime::where('type','exam')->find($id);
            $class_times = AramiscClassTime::where('type','exam')->get();

...
class Standard extends PrettyPrinterAbstract {
    ...
    protected function pExpr_Ternary(Expr\Ternary $node, int $precedence, int $lhsPrecedence): string {
        ...
        return $this->pAramiscOp(Expr\Ternary::class,
